 ...
 */
export function generateSrcsetString(imageUrl, originalWidth = 1320, originalHeight = 920, breakpoints = [480, 768, 1320]) {
  if (!imageUrl) return '';
  ...
  breakpoints.sort((a, b) => a - b).forEach(targetWidth => {
    ...
    // Küçük/orta boyutlar için kaliteyi biraz düşür (örn. 768px ve altı)
    const quality = width <= 768 ? 75 : 80;
